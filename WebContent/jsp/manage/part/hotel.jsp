...
<script type="text/javascript">
	function addclick(num) {
		window.location.href = "jsp/manage/part/hotel.jsp?isadd=1";
	}
	function submitform() {
...
<body>
	<form id="form1" name="form1" action="HotelsServlet${param.item_id==null? null:'?sign_car=updata'}" style="background-color: #EEEEEE; padding-top: 20px; width: 100%; padding: 20px" method="post">
		<div align="center">
			<h2>租车信息表</h2>
			<div align="right">
						...
						<c:choose>
							<c:when test="${num.index%2==0}">
								<tr align="center" class="item">
									...
									<td>${car.address}</td>
									<td>
										<a href="jsp/manage/part/hotel.jsp?&item_id=${car.id}">修改</a>
										&nbsp;
										<a href="HotelsServlet?sign_car=delete&item_id=${car.id}">删除</a>
									</td>
								</tr>
							</c:when>
							<c:when test="${num.index%2!=0}">
