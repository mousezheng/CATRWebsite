...
<!-- 	position:absolute;悬浮 -->
			<div style=" z-index:2; width: 100%; height:600px ;background-color: 282828; "
			align="center">
			<form name="form1" id="form1" action="LoginCheck" method="post"
				...
				<table align="center" style="font-size: 25px;color:EEEEEE; border-collapse: separate;border-spacing: 13px" >
					...
					<tr>
						...
						<td><a href="./registered.jsp">用户注册</a>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td style="font-size: 30px">
							...
							checked="true">用户 &nbsp <input style="width: 20px;height:20px" type="radio"
							value="teacher" name="position">管理员</td>
						<td></td>
					</tr>
					<tr>
						<td ><input class="btn btn-lg btn-primary" style="font-size: 25px" type="button" value="提交" onclick="login_check()" />
