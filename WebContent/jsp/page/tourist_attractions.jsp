...
<body>
	...
	<!-- 			<div style="width: 80%;height: 560px; float: left;"> -->
	<!-- 				<font size="5">翠华山</font><br /> <font size="2" -->
	<!-- 					>翠华山原名太乙山，景区由碧山湖景区、天池景区和山崩石海景区3部分组成。传说有太乙真人在此修炼过，由此得名。 -->
	<!-- 					翠华山旅游景区位于西安城南20公里处秦岭北麓，景区面积32平方公里。1992年被国家林业部评为“终南山国家森林公园”；1993年被评为“省级名胜风景区”；1997年被评为“西安旅游十大景”；2001年被国土资源部评为“陕西翠华山山崩景观国家地质公园”；2002年被国家旅游局评为“AAAA级旅游景区”；2009年被联合国教科文组织评为“秦岭终南山世界地质公园”；[1] -->
	<!-- 					同年被评为“陕西省平安景区”；2010年被评为“陕西省平安示范景区”[2] 2012年荣获国家级水利风景区。</font> -->
	<!-- 			</div> -->
	<!-- 			<img alt="景点图片" src="resources/翠华山/image.jpg" class="item_image"> -->
	<!-- 		</div> -->
	<!-- 	</div> -->
	<div style="padding: 20px; padding-bottom: 100px" align="center">
		<table style="border-collapse: separate; border-spacing: 0px 10px; width: 79%; float: left;">
			<tr>
				<td width="100%-200px" style="background-color: #eeeeee; padding: 20px">
			...
			<tr>
				...
				<td width="100px">
					<img alt="景点图片" src="resources/大雁塔/image.jpg" width="160px" height="160px">
				</td>
			</tr>
			<tr>
				<td width="100%-200px" style="background-color: #eeeeee; padding: 20px">
				...
				<td width="100px">
					<img alt="景点图片" src="resources/壶口瀑布/image.jpg" width="160px" height="160px">
				</td>
			</tr>
			<tr>
				<td width="100%-200px" style="background-color: #eeeeee; padding: 20px">
		...
		<div style="width: 20%; height: 480px; background-color: #EEEEEE; float: right; padding-top: 0px" align="center">
			<form action="" style="background-color: #FFFFFF;padding-top: 10px">
				<input type = "text" width="70%" height="40px">
				<a href="https://www.baidu.com/"><img alt="图标" src="resources/query.png" width="20%" height="40px"/></a>
			</form>
			 <font size="5">景点热搜排行榜</font> <br />
			······
			<br /> <hr width="5px" /> <a href="">
			...
			</a> <hr style="height: 5px; border: none; border-top: 5px ridge green;" />
		</div>
	</div>
</body>
</html>